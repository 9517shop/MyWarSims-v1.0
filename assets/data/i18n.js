const I18N = {
    "zh-TW": {
        ...
        "btn_reset": "🔄 重置下一局",
        "btn_export": "💾 匯出",
        "btn_export_stats": "📤 EXPORT STATS",
        "btn_import_stats": "📥 IMPORT STATS",
        ...
        "log_heal": "[{0}s] [玩家 {1}] {2}{3} 治療了 [玩家 {4}] {5}{6}，恢復 {7} HP。",
        "log_skill_warlock": "🔥 [{0}s] [玩家 {1}] {2}{3} 施放火球術！",
        "log_status_burn": "🔥 [{0}s] {1}{2} 受到燃燒傷害 -{3} HP",
        "log_status_poison": "☠️ [{0}s] {1}{2} 受到中毒傷害 -{3} HP",
        "log_status_bleed": "🩸 (出血附加 -{0} HP)",
        "log_status_shield": "🛡️ (護盾完全抵擋)",
        "log_win": "🏆 <b>玩家 {0} 獲勝！</b>",
        "log_draw": "🤝 <b>雙方平手！</b>",
    ...
    "en": {
        ...
        "log_heal": "[{0}s] [Player {1}] {2}{3} heals [Player {4}] {5}{6} for {7} HP.",
        "log_skill_warlock": "🔥 [{0}s] [Player {1}] {2}{3} casts Fireball!",
        "log_status_burn": "🔥 [{0}s] {1}{2} takes Burn DMG -{3} HP",
        "log_status_poison": "☠️ [{0}s] {1}{2} takes Poison DMG -{3} HP",
        "log_status_bleed": "🩸 (Bleed -{0} HP)",
        "log_status_shield": "🛡️ (Shield Blocked)",
